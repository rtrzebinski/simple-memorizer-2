...
<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
	...
	<div id="actions">
		<input id='good_answer_button' class="btn btn-default btn-success btn-lg" type="submit" value="I know" name="add_good_answer">&nbsp;&nbsp;&nbsp;
		<input id='bad_answer_button' class="btn btn-default btn-danger btn-lg" type="submit" value="I don't know" name="add_bad_answer">&nbsp;&nbsp;&nbsp;
